...
"use strict";
/* harmony import */ var main_utils_regular_regular_expression_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var main_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    regularValid: function regularValid(type, value) {
      ...
      if (Object(main_utils__WEBPACK_IMPORTED_MODULE_1__[/* isEmpty */ "a"])(regExpression)) {
        return value;
      }
    ...
    regularMatch: function regularMatch(type, value) {
      if (Object(main_utils__WEBPACK_IMPORTED_MODULE_1__[/* isEmpty */ "a"])(value)) {
        return value;
      }
    ...
    queryExpression: function queryExpression(type) {
      if (Object(main_utils__WEBPACK_IMPORTED_MODULE_1__[/* isEmpty */ "a"])(type)) {
        return this.regex;
      }
      var regExpression = '';
      if (type.indexOf(':') > 0) {
        var types = type.split(':');
        regExpression = main_utils_regular_regular_expression_js__WEBPACK_IMPORTED_MODULE_0__[/* regularExpression */ "a"][types[0]](types[1]);
      } else {
        regExpression = main_utils_regular_regular_expression_js__WEBPACK_IMPORTED_MODULE_0__[/* regularExpression */ "a"][type];
      }
      return regExpression;
    },
    isRepairZero: function isRepairZero(matchValue, regularType) {
      // 值不为空,regularType不为空
      if (Object(main_utils__WEBPACK_IMPORTED_MODULE_1__[/* isEmpty */ "a"])(matchValue) || Object(main_utils__WEBPACK_IMPORTED_MODULE_1__[/* isEmpty */ "a"])(regularType)) {
        return false;
      }
      // 最后有.
...
// UNUSED EXPORTS: random, regluarUtil, formatDate, formatDateTime, confirm, isArray, isString, isNumber, isBoolean, isUndefined, isNull, isObject, isFunction, isDate, isEmptyObject, findComponentDownward, findComponentUpward, findComponentsUpward, findComponentsDownward, findBrothersComponents
...
// EXTERNAL MODULE: ./src/mixins/regular-valid-mixin.js
var regular_valid_mixin = __webpack_require__(17);
