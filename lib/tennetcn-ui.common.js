  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._t("title", [_vm._v(_vm._s(_vm.title))], { title: _vm.title })],
        2
      ),
      _vm._t("default")
    ],
          ...
          _vm._b(
            {
              ...
              scopedSlots: _vm._u(
                [
                  _vm._l(_vm.formatColumns, function(col) {
                    return {
                      key: col.name,
                      fn: function(ref) {
                        var value = ref.value
                            ...
                            [
                              _vm._v(
                                "\n        " +
                                  _vm._s(
                                    col.formatter
                                      ? col.formatter(rowData, col, value)
                                      : value
                                  ) +
                                  "\n      "
                              )
...
/* harmony default export */ var tree_tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    openAll: function openAll(val) {
      // treeToArray(this.data, val)
      var me = this.$refs.eltable;
      var exp = function exp(ary) {
